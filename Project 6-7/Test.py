...
('lb'   , pattern((('op', 'lb'),   ('rd', register()), ('rs', register()), ('uimm', uintegerpattern())), can_have_label=True),      "lb rd rs uimm      -->  $rd := MEM[$rs + uimm]",            lambda m, params : '1010'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('uimm'),4)) ),
('sb'   , pattern((('op', 'sb'),   ('rd', register()), ('rs', register()), ('uimm', uintegerpattern())), can_have_label=True),      "sb rd rs uimm      -->  MEM[$rs + uimm] := $rd",            lambda m, params : '1011'+str(reg2bin(m.group('rd'),REGISTER_ADDRESS_SIZE))+str(reg2bin(m.group('rs'),REGISTER_ADDRESS_SIZE))+str(uint2bin(m.group('uimm'),4)) )
]
...
('ldi'  , pattern((('op', 'ldi'),  ('rd', register()), ('imm', integerpattern())), can_have_label=True),                            "ldi rs imm     -->  rd := imm",                    lambda m, params : '1100'+str(reg2bin(m.group('rd'),4))+str(int2bin(m.group('imm'),8))),
...
('addi' , pattern((('op', 'addi'), ('rd', register()), ('rs', register()), ('imm', integerpattern())), can_have_label=True),        "addi rd rs imm -->  rd := rs + imm",               lambda m, params : '1101'+str(reg2bin(m.group('rd'),4))+str(reg2bin(m.group('rs'),4))+str(int2bin(m.group('imm'),4))),
